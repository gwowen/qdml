//Quick 'n' Dirty Maths Library (QDML) - a quick and dirty maths library that I've
//hacked together for use in OpenGL programs. Contains just about all the functions
//you need... but a bit quick and dirty in its implmenetation.
#ifndef _VECMATH_H_
#define _VECMATH_H_
...
namespace qdml
{
  /*declare the three basic types that make up qdml:
   N * M matrix, N-dimensional vector, and quaternions*/
